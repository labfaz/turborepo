...
export const Step3: FC = () => {
  const { values, setFieldValue } = useFormikContext<Step3FormikValues>();

  const options = [
    { value: 'nome', label: values.artist.name as string },
    { value: 'nome social', label: values.artist.social_name as string },
    { value: 'nome artistico', label: values.artist.artistic_name as string },
  ];
