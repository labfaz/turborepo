...
export const useSubscribeToCouse = (courseId: string, userToken?: string) =>
  useMutation([`/courses/${courseId}/subscribe`, userToken], () =>
...
export const useSubscription = (courseId: string, userToken?: string) =>
  useQuery(`/courses/${courseId}/subscription/${userToken}`, () =>
    checkSubscription(courseId, userToken)
  );
