import { defaultApiUrl, defaultClientUrl, defaultStrapiHost, getApiPort, getApiUrl, getClientPort, getClientUrl, getStrapiPort, getStrapiUrl, } from '.';
// reset test env between tests
const resetTestEnv = () => {
    // make copy of old env
    const OLD_ENV = process.env;
    beforeEach(() => {
        jest.resetModules(); // most important - it clears the cache
        process.env = Object.assign({}, OLD_ENV); // make a copy
    });
    afterAll(() => {
...
describe('server-conn-info', () => {
    ...
    describe('api url', () => {
        ...
        test('works on production without env vars', () => {
            process.env.NODE_ENV = 'production';
            delete process.env.REACT_APP_API_URL;
            delete process.env.API_URL;
