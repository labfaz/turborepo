...
// STRAPI
const getStrapiUrlEnvVar = () =>
  process.env.STRAPI_URL ?? process.env.REACT_APP_STRAPI_URL;
export const getStrapiPort = () => 1337;

export const defaultStrapiHost = `backoffice.labfaz.com.br/`;
export const getStrapiHost = () =>
  process.env.NODE_ENV === 'production'
    ? defaultStrapiHost
...
const getClientUrlEnvVar = () =>
  process.env.CLIENT_URL ?? process.env.REACT_APP_CLIENT_URL;
